...
The result is a dual ledger architecture: a public payment ledger on HashKey Chain and an encrypted compliance ledger on Zama fhEVM, permanently linked through a deterministic transaction reference.
