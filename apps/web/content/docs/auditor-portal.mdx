...
**Key Wrapping:** When the business authorizes the auditor, their browser takes the company's master AES compliance key and securely encrypts it using the auditor's *public* Ethereum key (via ECIES). This encrypted key is uploaded on-chain.
